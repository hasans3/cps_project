# -*- coding: utf-8 -*-
"""
Created on Tue Aug 16 09:22:37 2016
...
def DSS_Python_Interface1(filepath, contingency_range, blackout_criterion, system_name):
...
# Setting up the com interface and the necessary files    
    ...
    import maptest9bus_test_system
    import load_maptest9bus
    import numpy as np
...
# -------------------------------- Getting the contingency range -------------------------------
    contingencies = maptest9bus_test_system.maptest9bus_test_system(contingency_range);
...
#    ---------------------------- Checking the blackout criterion ------------------------------------------------
                T_sys_load, amt_load_loss = load_maptest9bus.load_maptest9bus(load_loss); 
...
#    ---------------------------- code for xml generation -------------------------------
    ...
    with open(data_path, "w") as f:
        f.write(xml_str);
#    ------------------------------------------------------------------------------------            
DSS_Python_Interface1("'G:\saqib\open DSS\opendss_matlab_interface\ieee9bus_system.dss'", 2, 40, 'ieee_9bus_system.xml');