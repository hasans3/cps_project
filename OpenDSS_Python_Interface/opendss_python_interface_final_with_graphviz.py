...
# ---------------------------- code for xml generation ---------------------------
    with open(data_path, "w") as f:
        f.write(xml_str);
    print 'Total number of blackout scenarios: %s' %blackout_counter
# --------------------------------------------------------------------------------            
DSS_Python_Interface1("'G:\saqib\ieee14bus_system.dss'", "G:\saqib\open DSS\OpenDSS_Python_Interface\component_data.txt", "G:\saqib\open DSS\OpenDSS_Python_Interface\Load_data.txt", 5, 40, 'ieee14bus_system.xml', 'ieee14bus_digraph_point2.gv');