...
#    ---------------------------- code for xml generation -------------------------------
    ...
    with open(data_path, "w") as f:
        f.write(xml_str);
#    ------------------------------------------------------------------------------------            
DSS_Python_Interface1("'G:\saqib\ieee14bus_system.dss'", "G:\saqib\open DSS\OpenDSS_Python_Interface\component_data.txt", "G:\saqib\open DSS\OpenDSS_Python_Interface\Load_data.txt", 1, 15, 'ieee14bus_system.xml');