# -*- coding: utf-8 -*-
"""
Created on Thu Oct 13 11:54:40 2016
...
#                my_outage.appendChild(my_outage_text);
                data['Initial stage'] =  initial_loss;
#     -----------------------------------------------------------------------                
...
#                    print "Stage {0}, Components Failed: {1} ".format(stagecounter, line_loss)
                    data['cascade stage'].append((stagecounter, line_loss))
#     --------------code for xml generation-----------------------------------------                    
...
#    ----------------- Resetting the simulation back to normal -----------------------
            data['Final stage'] = final_stage_text;
...
#    ------------------------------------------------------------------------------------            
DSS_Python_Interface1("'G:\saqib\open DSS\OpenDSS_Python_Interface\ieee_57_bus_system\ieee57bussystem1.dss'", "G:\saqib\open DSS\OpenDSS_Python_Interface\ieee_57_bus_system\component_data.txt", "G:\saqib\open DSS\OpenDSS_Python_Interface\ieee_57_bus_system\Load_data.txt", 1, 15, 'ieee57bus_system_N-1_test.json');
