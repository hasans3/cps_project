...
# Setting up the com interface and the necessary files    
    ...
    import maptest14bus_test_system_with_select_line_outage
...
# -------------------------------- Getting the contingency range -------------------------------
    contingencies = maptest14bus_test_system_with_select_line_outage.maptest14bus_test_system(comp_filename, contingency_range);
...
# --------------------------------------------------------------------------------            
DSS_Python_Interface1("'G:\saqib\ieee14bus_system.dss'", "G:\saqib\open DSS\OpenDSS_Python_Interface\component_data.txt", "G:\saqib\open DSS\OpenDSS_Python_Interface\Load_data.txt", 1, 40, 'ieee14bus_system.xml', 'ieee14bus_digraph_point3.gv');