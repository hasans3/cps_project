function [Total_line_loss, Total_line_loss_data1] = DSSStartuptest_reset8(blackout_criterion, filepath, systemName, contingency_range)
...
contingencies = maptest14bus1_test(contingency_range);
