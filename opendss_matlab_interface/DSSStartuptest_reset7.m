function [y] = DSSStartuptest_reset7(blackout_criterion, filepath, systemName, contingency_range)
...
[value] = maptest14bus1_test(contingency_range);
...
for i= 1:vcol
   ...
   %---------------------------------------------------------------%
    ...
    for p = 1:r_line_loss
        ...
        my_initial_outage_text = myObject.createTextNode(line_loss{p,1});
